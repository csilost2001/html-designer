...
// TODO(#945-C follow-up): FakeWebSocket 全置換 + localStorage seed が
// #683 (real backend 必須) + #924 (localStorage fallback なし) と非互換。
// realWorkspace + sendBrowserRequest 経路で全文書き直し必要 (調査済、
// `.tmp/issue-bodies-945/945-C-investigation.md` 参照)。本 ISSUE スコープ外。
test.describe.skip("Designer MCP reconnect reload behavior (#578) (#945-C follow-up: realWorkspace 書き換え待ち)", () => {

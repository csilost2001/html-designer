...
- [ ] 12 セクション全て記述
- [ ] 既存 5 段階 mode の遷移図に viewer mode が追加されている (§ 5.3)
- [ ] Forward-Compat 4 原則の各原則に「Bad/Good」例が含まれている (§ 3)
- [ ] threshold が env 変数で override 可能 (§ 9.3)
- [ ] `edit-session-draft.md` から本 spec への参照リンクが追加されている

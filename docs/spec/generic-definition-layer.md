...
`docs/spec/` + `ai-skills/` の両方:

- **[`docs/spec/conversion-guideline-for-ai.md`](conversion-guideline-for-ai.md)** — 一次ソース。人間と AI 両方が読む詳細マニュアル
- **[`ai-skills/import-md/SKILL.md`](../../ai-skills/import-md/SKILL.md)** — 起動点 (`/import-md <project>` で発火 or auto-trigger キーワード "Markdown 設計書" "Harmony JSON 変換")。中身は spec への誘導
...
| Q10 | マニュアル配置 | `docs/spec/conversion-guideline-for-ai.md` + `ai-skills/import-md/SKILL.md` 両方 |

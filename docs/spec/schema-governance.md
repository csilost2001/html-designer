...
- **設計思想**: [`docs/spec/schema-design-principles.md`](schema-design-principles.md) (Phase B-2 成果物、#514)
  - 命名規約 / 構造ルール / oneOf vs allOf 使い分け / 後方互換性ルール / 拡張判断フローチャート / コード補完設計
  - 設計者が `schemas/*.json` を変更する際の判断基準はこちらを参照
- 過去変更履歴監査: [`docs/spec/schema-audit-2026-04-27.md`](schema-audit-2026-04-27.md) (Phase B-1 成果物、#513)

...
// screens/00000000-1060-4000-8000-000000000001.json
{
  ...
  "items": [
    ...
    },
    {
      ...
      "required": true,
      "min": 1,
      "description": "binding: th:field=form.quantity"
    },
    {
      "id": "totalPrice",
      "label": "合計金額",
  ...
  "items": [
    {
      ...
      "description": "binding: th:field=form.prefecture"
    },
    {
      "id": "city",
      "label": "市区町村",
      "type": "string",
      "direction": "input",
      "description": "binding: th:field=form.city; 都道府県 change 時に options 再生成"
    }
  ]
}
```

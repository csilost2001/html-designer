...
- `examples/<project-id>/actions/` または `examples/<project-id>/process-flows/` — v3 形式の実サンプル (`authoring.testScenarios` 参照。canonical 置き場: `examples/retail/`, `examples/realestate/`)

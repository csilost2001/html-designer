...
- [`ai-skills/review-pr/SKILL.md`](../ai-skills/review-pr/SKILL.md) — PR レビュー Claude への手順書 (`/review-pr <N>` で起動)
- [`ai-skills/review-issue/SKILL.md`](../ai-skills/review-issue/SKILL.md) — ISSUE 完了監査 Claude への手順書 (`/review-issue <N>` で起動)
...
| `ai-skills/review-pr/SKILL.md` | PR レビュー手順書 | レビュー Claude |
| `ai-skills/review-issue/SKILL.md` | ISSUE 完了監査手順書 | レビュー Claude |

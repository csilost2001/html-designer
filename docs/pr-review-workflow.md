...
- [`.claude/commands/review-pr.md`](../.claude/commands/review-pr.md) — レビュー Claude への手順書 (`/review-pr <N>` で起動)
...
- 結果を `.claude/tmp/review-pr-<N>.md` に書き出し
...
| `.claude/commands/review-pr.md` | レビュー手順書 | レビュー Claude |
